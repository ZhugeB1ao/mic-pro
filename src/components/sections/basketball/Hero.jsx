      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
          <div className="flex flex-col items-start lg:col-span-4">
            ...
            <p className="mt-6 text-sm sm:text-base text-slate-600 leading-relaxed max-w-md font-medium">
              {content.description}
            </p>
            ...
            <div className="mt-8">
              <Button
                ...
                className="inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-sm font-semibold !text-slate-900 shadow-lg shadow-slate-200/80 border border-slate-100 hover:bg-slate-50 transition-all duration-300"
              >
