    ...
    <section id="hero" className="relative bg-transparent pt-16 pb-100 md:pt-24 md:pb-20">
      <Container className="flex flex-col items-center text-center">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Button
            variant="primary"
            className="px-8 py-3.5 flex items-center gap-2 text-base rounded-full shadow-lg shadow-blue-200"
          >
          ...
          <Button
            variant="light"
            className="px-8 py-3.5 text-base rounded-full bg-transparent text-slate-800 hover:bg-slate-100/40"
          >
            <Play
              size={18}
              aria-hidden="true"
