          ...
          {items.map((testimonial) => (
            ...
            >
              <div className="relative">
                <div
                  className={`relative h-20 w-20 overflow-hidden rounded-full ${testimonial.bgColor || "bg-orange-200"}`}
                >
                  <Image
                ...
                <div className={`absolute -bottom-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full ${testimonial.bgColor || "bg-orange-200"}`}>
              ...
              <div
                className={`relative z-10 mt-8 flex items-center gap-4 border-t-2  ${testimonial.borderColor || "border-orange-200"} pt-3`}
              >
                <div>
